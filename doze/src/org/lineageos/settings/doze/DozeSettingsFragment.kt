...
class DozeSettingsFragment : PreferenceFragmentCompat(), OnPreferenceChangeListener,
    ...
    private lateinit var pickUpPreference: SwitchPreference
    private lateinit var handwavePreference: SwitchPreference
    private lateinit var pocketPreference: SwitchPreference
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        if (savedInstanceState == null &&
            !prefs.getBoolean("first_help_shown", false)
        ) {
            showHelp()
        }
        ...
        switchBar = findPreference<MainSwitchPreference>(DozeUtils.DOZE_ENABLE)!!
