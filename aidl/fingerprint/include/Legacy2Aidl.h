...
inline void translate(const ::aidl::android::hardware::keymaster::HardwareAuthToken& authToken, hw_auth_token_t& hat) {
...
inline void translate(const hw_auth_token_t& hat, ::aidl::android::hardware::keymaster::HardwareAuthToken& authToken) {
    ...
    authToken.authenticatorType =
            static_cast<::aidl::android::hardware::keymaster::HardwareAuthenticatorType>(be32toh(hat.authenticator_type));
