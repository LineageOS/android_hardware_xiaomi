...
interface IEventCallback {
  String notifyCallback(in vendor.xiaomi.hardware.aidlbgservice.CallbackData callbackData);
  String notifySnapshotAvailability(int available);
  String notifyCallbackInfo(in vendor.xiaomi.hardware.aidlbgservice.CallbackInfo info);
